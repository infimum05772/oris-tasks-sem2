...
@EnableJpaRepositories("ru.kpfu.itis.arifulina.repository")
public class PersistenceConfig implements EnvironmentAware {
    ...
    public EntityManagerFactory entityManagerFactory() throws PropertyVetoException {
        ...
        jpaVendorAdapter.setShowSql(Boolean.TRUE.equals(environment.getProperty("jdbc.show-sql", Boolean.class)));
        jpaVendorAdapter.setGenerateDdl(true); // set false to gen with migrations
        jpaVendorAdapter.setDatabasePlatform(environment.getProperty("hibernate.dialect"));

        LocalContainerEntityManagerFactoryBean entityManagerFactory = new LocalContainerEntityManagerFactoryBean();
        entityManagerFactory.setJpaVendorAdapter(jpaVendorAdapter);
        entityManagerFactory.setDataSource(dataSource());
        entityManagerFactory.setPackagesToScan("ru.kpfu.itis.arifulina.model");
